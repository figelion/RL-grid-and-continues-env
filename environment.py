...
import math
#grid66
grid66 = env.GridEnviroment(6, 6, "to_win")
...
#grid69
grid69 = env.GridEnviroment(6, 9,"to_win")
...
#grid1010
grid1010 = env.GridEnviroment(10, 10, "to_lose")
for x in range(10):
...
#grid2436
grid2436 = env.GridEnviroment(24, 36,"to_win")
...
#grid2525
grid2525 = env.GridEnviroment(25, 25, "to_lose")
